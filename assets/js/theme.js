...
var theme = {
    ...
    changeTheme: () => {
        const e = localStorage.getItem("theme"),
            t = () => e || (window.matchMedia("(prefers-color-scheme: light)").matches ? "light" : "light"),
            n = function() {
            ...
            i = function(e) {
                "auto" === e && window.matchMedia("(prefers-color-scheme: light)").matches ? (n(), document.documentElement.setAttribute("data-bs-theme", "light"), r()) : (n(), document.documentElement.setAttribute("data-bs-theme", e), r())
            };
        i(t());
        const a = e => {
            const t = document.querySelector(".switch-theme");
            null != t && ("light" == e ? t.setAttribute("data-value", "light") : "light" == e && t.setAttribute("data-value", "light"))
        };
        a(t()), window.matchMedia("(prefers-color-scheme: light)").addEventListener("change", (() => {
            "light" === e && "light" === e || i(t())
            ...
            document.querySelectorAll(".switch-theme").forEach((e => {
                e.addEventListener("click", (t => {
                    t.preventDefault();
                    let n;
                    n = "light" == e.getAttribute("data-value") ? "light" : "light", localStorage.setItem("theme", n), i(n), a(n)
                }))
            }))
        }))
    },
